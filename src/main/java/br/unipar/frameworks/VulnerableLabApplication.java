...
/**
 * Sprint 02 - Fase 1, item 3: senhas do seed codificadas com BCrypt.
 */
    ...
    CommandLineRunner seedData(UserRepository userRepository,
        ...
        return args -> {
            ...
            User student = new User(null, "Aluno", "aluno@lab.local",
                    passwordEncoder.encode("aluno123"), "USER");
            userRepository.save(admin);
            userRepository.save(student);

            Product p1 = new Product(null, "Notebook", "Notebook para testes em laboratorio", new BigDecimal("3500.00"));
            ...
            commentRepository.save(new Comment(null, "Comentario inicial do laboratorio", p2));
        };
    }
}
